...
const Navbar = () => {
  ...
  return (
    <div className=" w-full px-15 py-6 font-sans justify-between flex fixed z-[999] items-center backdrop-blur-lg">
      <div className="logo">
        <svg
          width="72"
          height="30"
        ...
        {["Services", "Our Work", "About Us", "Insights", "Contact"].map(
          (items, index) => {
            return (
              <a
                key={index}
                className={` links text-lg font-light relative group cursor-pointer ${
                  index === 4 ? "ml-50" : ""
                }`}
              >
                {items}
