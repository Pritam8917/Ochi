...
const Cards = () => {
  return (
    <div className="bg-[#F4F4F5] w-full h-screen">
      <div className="w-full flex gap-4 px-15">
        <div className="w-1/2 px-15 h-[27vw] bg-[#004D43] rounded-xl relative  flex items-center justify-center">
          <div className="absolute p-8 ">
            <svg
              ...
              className="w-[10vw] h-[10] text-[#CDEA68]"
            >
              <path
          ...
          <button className="  bottom-8 left-10 px-3 py-1 border-1 border-[#CDEA68] rounded-full absolute text-[#CDEA68] font-medium overflow-hidden">
            @2019-2022
          </button>
        </div>
        <div className="w-1/2  gap-4 flex">
          <div className="w-1/2 bg-[#212121]  px-15 h-[27vw] rounded-xl relative flex items-center justify-center">
            <div className="absolute p-8">
              <img
            ...
            <button className=" group absolute bottom-8 left-10 px-3 py-1 border-1 border-white rounded-full text-white uppercase overflow-hidden">
              <span className="relative z-20  duration-300 group-hover:text-black">
                Rating 5.O on clutch
              </span>
              <div className="absolute bottom-0 left-0 w-full h-full bg-white translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out z-10"></div>
            </button>
          </div>
          <div className="w-1/2 bg-[#212121] px-15 h-[27vw] rounded-xl relative flex items-center justify-center">
            <div className="absolute p-8">
            ...
            <button className=" group absolute bottom-8 left-10 px-3 py-1 border-1 border-white rounded-full text-white uppercase overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 w-full h-full bg-white translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out z-10"></div>
            </button>
          </div>
        </div>
      </div>
